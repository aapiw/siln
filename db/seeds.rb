...
Teacher.find(1).sks.new(sk_submission_id: 1, year: "2018").save(validate:false)
Teacher.find(1).sks.new(sk_submission_id: 2, year: "2019").save(validate:false)

Teacher.find(2).sks.new(sk_submission_id: 1, year: "2018").save(validate:false)
Teacher.find(4).sks.new(sk_submission_id: 1, year: "2018").save(validate:false)

Teacher.find(1).extension_of_tasks.new(extension_submission_id: 2, year: "2019").save(validate:false)

Teacher.find(2).extension_of_tasks.new(extension_submission_id: 1, year: "2018").save(validate:false)
Teacher.find(3).extension_of_tasks.new(extension_submission_id: 1, year: "2018").save(validate:false)
