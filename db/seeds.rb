...
SkSubmission.create(year:"2019", school_id:1)
SkSubmission.create(year:"2020", school_id:1)
...
ExtensionSubmission.new(school_id:1, year:"2018").save(validate: false)
ExtensionSubmission.new(school_id:1, year:"2019").save(validate: false)
ExtensionSubmission.new(school_id:1, year:"2020").save(validate: false)
...
Teacher.create(school_id:1, name:"Ani", pns:true, age:"40", period_of_teaching:"15", expire:Time.now.next_month)
Teacher.create(school_id:1, name:"Beni", pns:true, age:"40", period_of_teaching:"15", expire:Time.now.next_month)

# Teachers of school create sk submission
Teacher.last.sks.new(year: "2018", sk_submission_id:1).save(validate:false)
Teacher.find(1).sks.new(year: "2018", sk_submission_id:1).save(validate:false)
Teacher.find(1).sks.new(year: "2019", sk_submission_id:2).save(validate:false)

Teacher.find(2).sks.new(year: "2018", sk_submission_id:1).save(validate:false)

Teacher.find(4).sks.new(year: "2018", sk_submission_id:1).save(validate:false)
Teacher.find(4).sks.new(year: "2020", sk_submission_id:3).save(validate:false)

Teacher.find(1).extension_of_tasks.new(year: "2018", extension_submission_id:1).save(validate:false)

Teacher.find(2).extension_of_tasks.new(year: "2018", extension_submission_id:1).save(validate:false)
Teacher.find(3).extension_of_tasks.new(year: "2018", extension_submission_id:1).save(validate:false)
